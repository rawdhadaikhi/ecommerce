...
import { CREATE_ORDER_RESET } from '../JS/constants/orderConstants';
                        ...
                        (
                            <li key={item.product}>
                                <div className="row">
                                    ...
                                    <div> Qty {item.qty} x {item.price}  = {item.qty * item.price}DT</div>
                                </div>
                            </li>
                        ))}
                    </ul>
                      ...
                      <ul>
                          ...
                          <li>
                              <div className="row">
                                ...
                                <div><strong>{cart.totalPrice.toFixed(2) } DT</strong></div>
                              </div>
                          </li>
                          <li>
                              <button type="button"
